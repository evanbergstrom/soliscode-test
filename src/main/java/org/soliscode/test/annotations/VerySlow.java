...
/// **Very Slow Test Annotation**
///
/// This annotation is used to tag tests that take a significant amount of time to execute.
...
/// ```
///
/// Tests tagged with `@VerySlow` can be excluded from fast-running CI/CD pipelines or
/// local development cycles using JUnit 5 tag filtering.
///
/// ```bash
/// mvn test -Dgroups=!very-slow
/// ```
///
/// @see Tag
/// @see TestTags#VERY_SLOW
/// @since 1.0.0
