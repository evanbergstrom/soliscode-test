...
/// Contract for the [NavigableMap#higherEntry(Object)] method.
///
...
public interface HigherEntryContract<K, V, M extends NavigableMap<K, V>> extends MapContractSupport<K, V, M> {
    ...
    /// Tests that `higherEntry()` can be called.
    @Test
    @DisplayName("Test higherEntry can be called")
    default void testHigherEntry() {
