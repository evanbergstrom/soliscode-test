...
/// Contract for the [NavigableMap#lowerEntry(Object)] method.
///
...
public interface LowerEntryContract<K, V, M extends NavigableMap<K, V>> extends MapContractSupport<K, V, M> {
    ...
    /// Tests that `lowerEntry()` can be called.
    @Test
    @DisplayName("Test lowerEntry can be called")
    default void testLowerEntry() {
