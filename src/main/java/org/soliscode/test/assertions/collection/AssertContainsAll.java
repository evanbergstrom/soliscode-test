...
/// @since 1.0.0
final class AssertContainsAll extends IterableAssertion {
    ...
    /// Test if an array contains all of a set of elements. The elements are considered the same if the
    /// `equals` method returns true.
    ///
    /// @param expected  The elements the iterable must contain.
    /// @param actual    The array that should contain the elements.
    /// @throws AssertionFailedError if the array does not contain all the elements or if either of the iterable
    ///                              arguments is null.
    ...
    /// @throws AssertionFailedError if the iterable does not contain all the elements or if either of the iterable
    ///                              arguments is null.
    public static void assertContainsAll(final Iterable<?> expected, final Iterable<?> actual, final String message) {
    ...
    private static void checkContainsAll(final Iterable<?> expected, final Iterable<?> actual,
